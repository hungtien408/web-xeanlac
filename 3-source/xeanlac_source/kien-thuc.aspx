<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="kien-thuc.aspx.cs" Inherits="tin_tuc" %>
            ...
            <div id="silderNews" class="owl-carousel">
                <asp:ListView ID="lstNewHot" runat="server" DataSourceID="odsNewHot"
                    ...
                    <ItemTemplate>
                        <div class="item">
                            ...
                            <div class="item-box">
                                <div class="item-name">
                                    <a href='<%# progressTitle(Eval("ProductName")) + "-kt-" + Eval("ProductID") + ".aspx" %>'><%# TLLib.Common.SplitSummary(Eval("ProductName").ToString(), 60) %></a>
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
                ...
                <asp:ObjectDataSource ID="odsNewHot" runat="server" SelectMethod="ProductSelectAll"
                    ...
                    <SelectParameters>
                        ...
                        <asp:Parameter DefaultValue="35" Name="CategoryID" Type="String" />
