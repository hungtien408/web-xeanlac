...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container wapper-main">
        <div class="box-1">
                    ...
                    <asp:ListView ID="lstAbout" runat="server" DataSourceID="odsAbout"
                        ...
                        <ItemTemplate>
                            ...
                            <div class="about-left">
                                ...
                                <div class="view-more"><a href='<%# progressTitle(Eval("ProductName")) + "-gt-" + Eval("ProductID") + ".aspx" %>'>Xem thêm</a></div>
                            </div>
                        </ItemTemplate>
                        <LayoutTemplate>
                            <span runat="server" id="itemPlaceholder" />
            ...
            <div class="user-bg">
                ...
                <div class="item">
                    ...
                    <asp:ListView ID="ListView1" runat="server" DataSourceID="odsGocNhin"
                        EnableModelValidation="True">
                        <ItemTemplate>
                            <a href='<%# progressTitle(Eval("ProductName")) + "-gn-" + Eval("ProductID") + ".aspx" %>'><%# Eval("ProductName") %></a>
                            <p><%# TLLib.Common.SplitSummary(Eval("Content").ToString(), 120) %></p>
                        </ItemTemplate>
                        <LayoutTemplate>
                            <span runat="server" id="itemPlaceholder" />
                        </LayoutTemplate>
                    </asp:ListView>
                    <asp:ObjectDataSource ID="odsGocNhin" runat="server" SelectMethod="ProductSelectAll"
                        TypeName="TLLib.Product">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="1" Name="StartRowIndex" Type="String" />
                            <asp:Parameter DefaultValue="1" Name="EndRowIndex" Type="String" />
                ...
                <div class="news-related">
                    ...
                    <asp:ListView ID="lstServiceSame" runat="server" DataSourceID="odsGocNhinSame"
                        EnableModelValidation="True">
                        <ItemTemplate>
                            <li><a href='<%# progressTitle(Eval("ProductName")) + "-gn-" + Eval("ProductID") + ".aspx" %>'><%# Eval("ProductName") %></a></li>
                        </ItemTemplate>
                        <LayoutTemplate>
                            <ul>
                    ...
                    <asp:ObjectDataSource ID="odsGocNhinSame" runat="server" SelectMethod="ProductSelectAll"
                        TypeName="TLLib.Product">
                        <SelectParameters>
        ...
        <div class="default-product">
            ...
            <div class="view-more" style="float: right; margin: 0;"><a href="san-pham.aspx">Xem thêm</a></div>
        </div>
