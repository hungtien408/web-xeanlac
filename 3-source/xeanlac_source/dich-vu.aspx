<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="dich-vu.aspx.cs" Inherits="dich_vu" %>

<%@ Register Src="~/uc/uc-dich-vu.ascx" TagPrefix="uc1" TagName="ucdichvu" %>
        ...
        <div class="wrapper-main">
            <div class="ColContent">
                <div class="product-main">
                    <div class="wrapper-product wrapper-service">
                        <asp:ListView ID="lstService" runat="server" DataSourceID="odsService"
                            EnableModelValidation="True">
                            <ItemTemplate>
                                <div class="item">
                                    <div class="item-img">
                                        <a href='<%# progressTitle(Eval("ProductName")) + "-sci-" + Eval("CategoryID") + "-si-" + Eval("ProductID") + ".aspx" %>'>
                                    ...
                                    <div class="item-name"><a href='<%# progressTitle(Eval("ProductName")) + "-sci-" + Eval("CategoryID") + "-si-" + Eval("ProductID") + ".aspx" %>'><%# Eval("ProductName") %></a></div>
                                    <div class="view-all"><a href='<%# progressTitle(Eval("ProductName")) + "-sci-" + Eval("CategoryID") + "-si-" + Eval("ProductID") + ".aspx" %>'>Xem thêm</a></div>
                                </div>
                            </ItemTemplate>
                            <EmptyDataTemplate>
                        ...
                        <asp:ObjectDataSource ID="odsService" runat="server" SelectMethod="ProductSelectAll"
                            ...
                            <SelectParameters>
                                ...
                                <asp:QueryStringParameter QueryStringField="pci" DefaultValue="4" Name="CategoryID" Type="String" />
                ...
                <div class="pager">
                    <asp:DataPager ID="DataPager1" runat="server" PageSize="12" PagedControlID="lstService">
                        <Fields>
            ...
            <div class="ColAside">
                <uc1:ucdichvu runat="server" ID="ucdichvu" />
            </div>
        </div>
    </div>
</asp:Content>
