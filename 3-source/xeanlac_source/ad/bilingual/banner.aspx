<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="banner.aspx.cs" Inherits="ad_single_advertisement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước trang chủ 1260px x 480px)</span>
                                        <span class="required">(Kích thước trang con 1260px x 200px)</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="AdsBannerDelete"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="ddlSearchCategory" Name="AdsCategoryID"
