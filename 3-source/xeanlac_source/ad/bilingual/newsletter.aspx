<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="newsletter.aspx.cs" Inherits="ad_newsletter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <table class="search">
            ...
            <tr>
                ...
                <td>
                    <asp:RadEditor ID="txtContent" ContentFilters="ConvertCharactersToEntities,ConvertToXhtml,OptimizeSpans,IndentHTMLContent,ConvertFontToSpan,IECleanAnchors,FixUlBoldItalic,RemoveScripts,MakeUrlsAbsolute,FixEnclosingP" runat="server" Language="vi-VN" Skin="Office2007"
                        Width="503px">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            AllowSorting="True" AutoGenerateColumns="False" CssClass="grid" DataSourceID="OdsNewsletter"
