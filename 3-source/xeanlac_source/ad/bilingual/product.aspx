        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn DataField="IsNew" HeaderStyle-Width="1%" HeaderText="Tiêu biểu"
                    ...
                    <asp:GridTemplateColumn DataField="IsHot" HeaderText="Nổi bật" SortExpression="IsHot">
                        <ItemTemplate>
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 273px x 233px)</span>
                                                    ...
                                                    <tr>
                                                        <td class="left" colspan="2">
                                                            <asp:CheckBox ID="chkIsNew" runat="server" CssClass="checkbox" Text=" Tiêu biểu" Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsNew").ToString()) ? false : Eval("IsNew"))%>' Visible="false" />
                                                            &nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkIsHot" runat="server" CssClass="checkbox" Text=" Nổi bật" Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsHot").ToString()) ? false : Eval("IsHot"))%>' />
                                                            &nbsp;&nbsp;
                                        ...
                                        <div class="sub_box">
                                            ...
                                            <div class="cont">
                                                <asp:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                    ...
                                                    <span class="required">(Kích thước 485px x 414px)</span>
