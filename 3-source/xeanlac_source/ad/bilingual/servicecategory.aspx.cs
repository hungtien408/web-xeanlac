...
public partial class ad_single_productcategory : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string strDescription = ((RadTextBox)row.FindControl("txtDescription")).Text.Trim();//HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtDescription")).Content.Trim()));
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                if (!string.IsNullOrEmpty(strImageName))
                {
                    ...
                    ResizeCropImage.ResizeByCondition(strFullPath, 73, 57);
                }
                RadGrid1.Rebind();
            }
            else
