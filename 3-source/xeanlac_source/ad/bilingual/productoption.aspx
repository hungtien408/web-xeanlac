<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/inside.master" AutoEventWireup="true"
    CodeFile="productoption.aspx.cs" Inherits="ad_single_service" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" CssClass="invisible" runat="server">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductOptionTitle" runat="server" Width="130px">
                        </asp:RadTextBox>
                    </td>
                    <td class="left">
                        Mô tả
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadComboBox Filter="Contains" ID="ddlSearchCategory" runat="server" DataSourceID="ObjectDataSource2"
                            ...
                            OnDataBound="DropDownList_DataBound" Width="134px">
                        </asp:RadComboBox>
                    </td>
                    <td class="left">
                        Tag
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" AllowPaging="True"  
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductOptionID" SortExpression="ProductOptionID">
                    </asp:GridBoundColumn>
                    <asp:GridBoundColumn DataField="ProductOptionTitle" HeaderText="Tiêu đề" SortExpression="ProductOptionTitle" />
                    <asp:GridBoundColumn DataField="ProductOptionCategoryName" Visible="False" HeaderText="Danh mục"
                        SortExpression="ProductOptionCategoryName" />
                    ...
                    <asp:GridTemplateColumn HeaderText="New" SortExpression="IsNew" Visible="False">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkIsNew" runat="server" Checked='<%# string.IsNullOrEmpty(Eval("IsNew").ToString()) ? false : Eval("IsNew") %>'
                                CssClass="checkbox" />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Hot" SortExpression="IsHot" Visible="False">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkIsHot" runat="server" Checked='<%# string.IsNullOrEmpty(Eval("IsHot").ToString()) ? false : Eval("IsHot") %>'
                                CssClass="checkbox" />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Xem trên trang chủ" Visible="False" SortExpression="IsShowOnHomePage">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn DataField="ImageName" HeaderText="Ảnh" SortExpression="ImageName">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'>
                                <img alt="" src='<%# "~/res/productoption//thumbs/" + Eval("ImageName") %>' width="70"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ImageName").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductOptionID") + "#" + Eval("ImageName") %>'
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <table class="search">
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadComboBox Filter="Contains" ID="ddlCategory" runat="server" DataSourceID="ObjectDataSource2"
                                            DataTextField="ProductOptionCategoryName" DataValueField="ProductOptionCategoryID"
                                            Width="504px" OnDataBound="DropDownList_DataBound">
                                        </asp:RadComboBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtTag" runat="server" Text='<%# Bind("Tag") %>' Width="500px"
                                            EmptyMessage="Tag...">
                                        </asp:RadTextBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtMetaTittle" runat="server" Text='<%# Bind("MetaTittle") %>'
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtProductOptionTitle" runat="server" Text='<%# Bind("ProductOptionTitle") %>'
                                            Width="500px" EmptyMessage="Tiêu đề...">
                                        </asp:RadTextBox>
                                        <%--<asp:TextBox ID="txtProductOptionTitle" runat="server" Text='<%# Bind("ProductOptionTitle") %>'
                                ...
                                <tr>
                                    <td class="left" colspan="2">
                                        <asp:CheckBox ID="chkIsHot" runat="server" Visible="False" CssClass="checkbox" Text=" Hot"
                                            Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsHot").ToString()) ? false : Eval("IsHot"))%>' />
                                        <asp:CheckBox ID="chkIsNew" runat="server" Visible="False" CssClass="checkbox" Text=" New"
                                            Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsNew").ToString()) ? false : Eval("IsNew"))%>' />
                                        <asp:CheckBox ID="chkIsShowOnHomePage" Visible="False" runat="server" CssClass="checkbox"
                                            Text=" Xem trên trang chủ" Checked='<%# (Container is GridEditFormInsertItem) ? true : (string.IsNullOrEmpty(Eval("IsShowOnHomePage").ToString()) ? false : Eval("IsShowOnHomePage"))%>' />
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            ...
            <asp:TextBoxSetting EmptyMessage="Tiêu đề ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductOptionTitle" />
                </TargetControls>
            </asp:TextBoxSetting>
        </asp:RadInputManager>
    </asp:RadAjaxPanel>
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductOptionSelectAll"
        TypeName="TLLib.ProductOption" DeleteMethod="ProductOptionDelete" UpdateMethod="ProductOptionUpdate">
        <DeleteParameters>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="ProductOptionCategorySelectAll"
        TypeName="TLLib.ProductOptionCategory"></asp:ObjectDataSource>
