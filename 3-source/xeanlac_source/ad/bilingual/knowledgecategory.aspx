<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="knowledgecategory.aspx.cs" Inherits="ad_single_productcategory" %>
                    ...
                    <asp:GridTemplateColumn HeaderText="Ảnh" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'>
                                ...
                                <img alt="" src='<%# "~/res/productcategory/" + Eval("ImageName") %>' width="80" runat="server"
                ...
                <EditFormSettings EditFormType="Template">
                    ...
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Danh Mục Kiến Thức</h3>
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 73px x 57px)</span>
                                    </td>
                                </tr>
                                <tr class="invisible">
