...
//Thay dia chi web
var endAddress = "10.7453147,106.587973";
//Thay toa do
var lat = 10.7453147, long = 106.587973;
window.onload = function () {
    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        var content = '<div class="box">' +
            '<h4>CÔNG TY CỔ PHẦN AN LẠC</h4>' +
            '<p><span class="fa fa-map-marker"></span>Lô số 5, Đường số 4, KCN Tân Tạo, P.Tân Tạo, Quận Bình Tân, Tp.HCM</p>' +            '<p><span class="fa fa-phone"></span>(+84 8) 37562 666 - 37562 888 - 37562 999</p>' +           '<p><span class="fa fa-envelope"></span>Email: <a href="mailto:anlac@anlaccorp.vn">anlac@anlaccorp.vn</p>' +
       '</div>';
